...
contract WealthyHabits is Context, IERC20, Ownable {
    ...
    string private _name = "Wealthy Habits";
    string private _symbol = "WHB";
    ...
    /**
     * @dev Transfers the given _amount of any ERC20/BEP20 tokens that are sent
     * by accident to this contract address, back to the _recipient address.
     */
    ...
    /**
     * @dev Transfers all BNBs that are sent by accident
     * to this contract address, back to the owners' address.
     */
